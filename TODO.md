...
**Current Version:** v0.2.9 (see VERSION file)

Full modularization of the monolith using TDD approach.

## Version History
- **v0.2.9** — Layout rearrange (hand bottom, actions/log right), BEGIN! crossbar animation, coin flip white text, equal stat panels with opponent mana
