...
export const VERSES = {
  ...
  manaDrain: { id:'manaDrain', name:'Mana Drain', type:'set', cost:1,
    ...
    trigger:'When opponent plays Cast Verse', text:'Negate spell.',
  ...
  denMother: { id:'denMother', name:'Den Mother', type:'set', cost:2,
    ...
    trigger:'When a creature you control is KO\'d', text:'Search your deck for a 1-cost creature and summon it.',
